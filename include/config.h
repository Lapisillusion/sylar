 ...
 */
    ...
    public:
        ...
        typedef std::function<void(const T &old_value, const T &new_value)> on_change_handler;
        ...
        void setValue(const T &v) {
            {
                ...
                for (auto &i: m_cbs) {
                    i.second(m_val, v); //(oldval newval)
                }
            }
         ...
         */
        uint64_t addListener(on_change_handler cb) {
         ...
         */
        on_change_handler getListener(uint64_t key) {
            RWMutexType::ReadLock lock(m_mutex);
    ...
    private:
        ...
        std::map<uint64_t, on_change_handler> m_cbs;
    };
    ...
    public:
        ...
        static typename ConfigVar<T>::ptr Lookup(const std::string &name,
            ...
            //vv(new ConfigVar<T>(name, default_value, description));
//            ConfigVar<T> *p =  new ConfigVar<T>(name, default_value, description);
//            auto v = ConfigVar<T>::ptr(p);
